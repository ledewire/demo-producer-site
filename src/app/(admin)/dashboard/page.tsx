...
export default async function DashboardPage() {
  ...
  let summary: Awaited<ReturnType<Awaited<ReturnType<typeof createMerchantClient>>['merchant']['sales']['summary']>>
  let recentSales: Awaited<ReturnType<Awaited<ReturnType<typeof createMerchantClient>>['merchant']['sales']['list']>>

  try {
    const client = await createMerchantClient()
    ;[summary, recentSales] = await Promise.all([
